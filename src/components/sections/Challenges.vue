...
<i18n>
{
  "en": {
    "title": "Challenges",
    "intro": "Here you find a list of all challenges. Why is this important? At the Climathon you have to decide as a team for <strong>ONE CHALLENGE</strong> on which you want to work and at the end submit your solution. Only in a few exceptions where it makes sense, a solution for <strong>two</strong> challenges can be offered.",
