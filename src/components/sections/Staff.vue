    ...
    <v-container>
      ...
      >
        ...
        >
          ...
          <v-btn class="my-3" outlined text small @click="toggleSpeaker(i)">{{
            $t('more')
          }}</v-btn>
            ...
            <v-card class="card" color="#2f3a58">
              <div class="dialog-card-content pa-4">
                ...
                <v-img
                  ...
                  :lazy-src="require('../../../static/placeholder.svg')"
                  :src="
                    speaker.icon || require('../../../static/placeholder.svg')
                  "
                  max-height="128px"
                  max-width="128px"
                  height="128px"
      ...
      >
        ...
        >
          ...
          <v-btn class="my-3" outlined text small @click="toggleJudge(i)">{{
            $t('more')
          }}</v-btn>
            ...
            <v-card class="card" color="#2f3a58">
              <div class="dialog-card-content pa-4">
                ...
                <v-img
                  ...
                  :lazy-src="require('../../../static/placeholder.svg')"
                  :src="
                    judge.icon || require('../../../static/placeholder.svg')
                  "
                  max-height="128px"
                  max-width="128px"
                  height="128px"
