<template>
  <section :style="{ backgroundColor: sectionColor }">
    <v-container>
      ...
      <p v-if="!postEvent" class="introSpeakers my-5" v-html="$t('introSpeakers')"></p>
      <v-img
        ...
        cover
      ></v-img>
      <v-layout v-if="speakers.length > 0" class="my-4" row wrap align-start justify-center>
        <v-flex
        ...
        >
          ...
          <v-btn class="my-3" outlined text small @click="toggleSpeaker(i)">{{ $t('more') }}</v-btn>
            ...
            <v-card class="card" color="#2f3a58">
              <div class="dialog-card-content pa-4">
                <v-layout row>
                  ...
                  <v-spacer />
                  <h3 class="mb-3">{{ speaker.name }}</h3>
                  <v-spacer />
                  <v-btn class="ma-0" color="accent" text @click="speaker.show = false" icon>
                    <v-icon>close</v-icon>
                  </v-btn>
                </v-layout>
                <v-img
              ...
              <v-card-actions class="dialog-card-footer">
                <v-spacer />
                <v-btn color="accent" text @click="speaker.show = false">
                  {{
                  $t('button.close')
                  }}
                </v-btn>
      ...
      <v-layout v-if="jury.length > 0" class="my-4" row wrap align-start justify-center>
        <v-flex
        ...
        >
          ...
          <v-btn class="my-3" outlined text small @click="toggleJudge(i)">{{ $t('more') }}</v-btn>
            ...
            <v-card class="card" color="#2f3a58">
              <div class="dialog-card-content pa-4">
                <v-layout row>
                  <div class="ml-3 mr-4">&nbsp;</div>
                  <v-spacer />
                  <h3 class="mb-3">{{ judge.name }}</h3>
                  <v-spacer />
                  <v-btn class="ma-0" color="accent" text @click="judge.show = false" icon>
                    <v-icon>close</v-icon>
                  </v-btn>
                </v-layout>
                <v-img
              ...
              <v-card-actions class="dialog-card-footer">
                <v-spacer />
                <v-btn color="accent" text @click="judge.show = false">
                  {{
                  $t('button.close')
                  }}
                </v-btn>
      ...
      <p v-if="!postEvent" class="introMentors my-5" v-html="$t('introMentors')"></p>
      <v-layout v-if="!postEvent" class="mb-5" row align-center justify-center wrap>
        <v-btn
          class="mt-2"
          width="auto"
      ...
      <v-img
        ...
        cover
      ></v-img>
      <v-layout v-if="mentors.length > 0" class="my-4" row wrap align-start justify-center>
        <v-flex
