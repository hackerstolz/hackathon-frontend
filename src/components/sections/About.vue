...
<i18n>
{
  ...
  "de": {
    ...
    "textWhat": [
      "Wir wollen nicht nur über Nachhaltigkeit sprechen, sondern versuchen zu sehen, was die Technologie zur Bekämpfung des Klimawandels beitragen kann. Deshalb veranstalten der Hackerstolz e.V. zusammen mit der Wirtschaftsförderung der Stadt Mannheim und der Klimaschutzagentur Mannheim den Climathon. Der Climathon ist eine überregionale Initiative des Climate-KIC vom EIT, die in Hunderten von Städten auf der ganzen Welt stattfindet. Werde Teil davon! 40 Stunden lang hast du die Möglichkeit, im Team gemeinsam Prototypen für digitale Lösungen zu entwickeln. Wir stellen dir öffentliche und nicht-öffentliche Umweltdaten sowie Daten aus der Wirtschaft zur Verfügung, mit denen du innovative grüne Lösungen entwickeln kannst.",
